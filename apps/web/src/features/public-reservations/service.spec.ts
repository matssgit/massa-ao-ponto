...
export const restaurant = { name: "Casa do Forno", slug: "casa-do-forno", address: "Rua das Oliveiras, 42", phone: "11987654321", timezone: "America/Sao_Paulo", deliveryEnabled: false, deliveryFeeCents: 0, operationalOverride: "DEFAULT" as const, openNow: true, operatingHours };

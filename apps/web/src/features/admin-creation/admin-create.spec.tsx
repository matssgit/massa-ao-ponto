...
const restaurant = { id: restaurantA, name: "Massa Centro", address: "Rua A, 10", phone: "11999999999", timezone: "America/Sao_Paulo", deliveryEnabled: true, deliveryFeeCents: 900, createdAt: timestamp, updatedAt: timestamp };
